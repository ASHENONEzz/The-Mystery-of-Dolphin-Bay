...
function aboutMe(){
    ...
    if(i==0){
        ...
        slogan2.innerHTML="这里是杨宗韬，一个19岁青年，这个废柴能熟练掌握面向百度编程、Windows和Linux的开关机、PS和PR的安装和卸载、还喜欢打篮球、CSGO和制作MMD，另外附上鄙人的B站主页，上面都是我制作的MMD，有兴趣可以支持一下。希望可以通过这次的小组大作业结识更多的新朋友，同时也与新朋友一起学习共同进步。";
    } else {
        i=0;
        slogan.style.height="50px";
        slogan2.innerHTML="组长、CIO、素材、美工";
    }
